...
3.本示例已迁移适配 API Version 20。

4.本示例需要使用支持 OpenHarmony API Version 20 的 DevEco Studio / SDK 环境才可编译运行。

5.本示例依赖 `@ohos.distributedHardware.deviceManager` 系统接口和 `ohos.permission.ACCESS_SERVICE_DM` 系统权限，运行时仍需要支持对应能力的设备与 Full SDK 环境。
