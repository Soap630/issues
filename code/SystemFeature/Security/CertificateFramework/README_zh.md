...
2、本示例已迁移至API version 20版本SDK，`build-profile.json5` 中的 `compileSdkVersion`、`compatibleSdkVersion` 和 `targetSdkVersion` 均已设置为 `20`。

3、编译前请确认本地已安装 OpenHarmony API 20 SDK，并使用已正确配置该 SDK 的 DevEco Studio 或 hvigor 环境进行构建。
